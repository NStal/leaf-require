(function(){
    ...
    ;(function(){
    var require = window.GlobalContext.requireModule.bind(window.GlobalContext,"dep.js");
    var module = {};
    module.exports = {};
...
(function() {
  alert("Dependencies successfully load");
    ...
    window.GlobalContext.setModule("dep.js",module,exec);
})()

;(function(){
    var require = window.GlobalContext.requireModule.bind(window.GlobalContext,"init.js");
    var module = {};
    module.exports = {};
    var exports = module.exports;
    function exec(){
...
(function() {
  ...
  bp.run();
    ...
    window.GlobalContext.setModule("init.js",module,exec);
})()
